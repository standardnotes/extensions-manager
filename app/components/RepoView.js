  ...
  updateComponentsWithNewPackageInfo() {
    ...
    for (let packageInfo of this.state.packages) {
      ...
      if (installed) {
        ...
        if (
          packageInfo.valid_until &&
          (!installed.content.valid_until ||
            new Date(installed.content.valid_until).getTime() !==
              validUntil.getTime())
        ) {
      ...
      <div className="sk-panel-section">
        <div className="sk-panel-section">
          <div className="sk-panel-row">
            <div className="sk-panel-section-title info sk-bold">
              Repository
            </div>
          </div>

          <a onClick={this.toggleOptions} className="info">
            Options
          </a>
          {this.state.showOptions && (
            <div className="sk-panel-row">
              <a onClick={this.deleteRepo} className="danger sk-a">
                Delete Repository
              </a>
            </div>
          )}
